...
import { ssrRenderComponent, ssrRenderVNode, ssrRenderSlot, ssrRenderClass, ssrInterpolate, ssrRenderList, ssrRenderSuspense, ssrRenderStyle, ssrRenderAttr } from 'vue/server-renderer';
...
const __nuxt_page_meta$1 = {
  title: "Sign In",
  layout: false
  // Don't use default layout for auth pages
};
...
const resource$1 = {
  "app": {
    "name": { "t": 0, "b": { "t": 2, "i": [{ "t": 3 }], "s": "Thought Cache" } },
    "description": { "t": 0, "b": { "t": 2, "i": [{ "t": 3 }], "s": "Capture your brilliant ideas anytime, anywhere" } }
  },
  "nav": {
    "dashboard": { "t": 0, "b": { "t": 2, "i": [{ "t": 3 }], "s": "Dashboard" } },
    "thoughts": { "t": 0, "b": { "t": 2, "i": [{ "t": 3 }], "s": "Thoughts" } },
  ...
  "auth": {
    ...
    "welcome": { "t": 0, "b": { "t": 2, "i": [{ "t": 3 }], "s": "Welcome to Thought Cache" } },
  ...
  "thoughts": {
    "title": { "t": 0, "b": { "t": 2, "i": [{ "t": 3 }], "s": "My Thoughts" } },
    "add": { "t": 0, "b": { "t": 2, "i": [{ "t": 3 }], "s": "Add Thought" } },
    "edit": { "t": 0, "b": { "t": 2, "i": [{ "t": 3 }], "s": "Edit Thought" } },
    "delete": { "t": 0, "b": { "t": 2, "i": [{ "t": 3 }], "s": "Delete Thought" } },
    ...
    "form": {
      ...
      "save": { "t": 0, "b": { "t": 2, "i": [{ "t": 3 }], "s": "Save Thought" } },
      "cancel": { "t": 0, "b": { "t": 2, "i": [{ "t": 3 }], "s": "Cancel" } }
    }
  },
  "categories": {
    "title": { "t": 0, "b": { "t": 2, "i": [{ "t": 3 }], "s": "Categories" } },
    "add": { "t": 0, "b": { "t": 2, "i": [{ "t": 3 }], "s": "Add Category" } },
    "edit": { "t": 0, "b": { "t": 2, "i": [{ "t": 3 }], "s": "Edit Category" } },
    "delete": { "t": 0, "b": { "t": 2, "i": [{ "t": 3 }], "s": "Delete Category" } },
    "form": {
      "name": { "t": 0, "b": { "t": 2, "i": [{ "t": 3 }], "s": "Category Name" } },
      "color": { "t": 0, "b": { "t": 2, "i": [{ "t": 3 }], "s": "Color" } },
      "icon": { "t": 0, "b": { "t": 2, "i": [{ "t": 3 }], "s": "Icon" } },
      "save": { "t": 0, "b": { "t": 2, "i": [{ "t": 3 }], "s": "Save Category" } },
      "cancel": { "t": 0, "b": { "t": 2, "i": [{ "t": 3 }], "s": "Cancel" } }
    }
  },
  "tags": {
    "add": { "t": 0, "b": { "t": 2, "i": [{ "t": 3 }], "s": "Add Tag" } },
    "placeholder": { "t": 0, "b": { "t": 2, "i": [{ "t": 3 }], "s": "Enter tag name..." } }
  },
  "ui": {
  ...
  "validation": {
    ...
    "minLength": { "t": 0, "b": { "t": 2, "i": [{ "t": 3, "v": "Minimum " }, { "t": 4, "k": "min" }, { "t": 3, "v": " characters required" }] } },
    "maxLength": { "t": 0, "b": { "t": 2, "i": [{ "t": 3, "v": "Maximum " }, { "t": 4, "k": "max" }, { "t": 3, "v": " characters allowed" }] } }
  }
};
const resource = {
  "app": {
    "name": { "t": 0, "b": { "t": 2, "i": [{ "t": 3 }], "s": "خزنة الأفكار" } },
    "description": { "t": 0, "b": { "t": 2, "i": [{ "t": 3 }], "s": "احفظ أفكارك الرائعة في أي وقت وفي أي مكان" } }
  },
  "nav": {
    "dashboard": { "t": 0, "b": { "t": 2, "i": [{ "t": 3 }], "s": "لوحة التحكم" } },
    "thoughts": { "t": 0, "b": { "t": 2, "i": [{ "t": 3 }], "s": "الأفكار" } },
    "categories": { "t": 0, "b": { "t": 2, "i": [{ "t": 3 }], "s": "الفئات" } },
    "settings": { "t": 0, "b": { "t": 2, "i": [{ "t": 3 }], "s": "الإعدادات" } },
    "profile": { "t": 0, "b": { "t": 2, "i": [{ "t": 3 }], "s": "الملف الشخصي" } },
    "language": { "t": 0, "b": { "t": 2, "i": [{ "t": 3 }], "s": "اللغة" } }
  },
  "auth": {
    "signIn": { "t": 0, "b": { "t": 2, "i": [{ "t": 3 }], "s": "تسجيل الدخول" } },
    "signOut": { "t": 0, "b": { "t": 2, "i": [{ "t": 3 }], "s": "تسجيل الخروج" } },
    "signUp": { "t": 0, "b": { "t": 2, "i": [{ "t": 3 }], "s": "إنشاء حساب" } },
    "welcome": { "t": 0, "b": { "t": 2, "i": [{ "t": 3 }], "s": "مرحباً بك في خزنة الأفكار" } },
    "createAccount": { "t": 0, "b": { "t": 2, "i": [{ "t": 3 }], "s": "إنشاء حسابك" } },
    "noAccount": { "t": 0, "b": { "t": 2, "i": [{ "t": 3 }], "s": "ليس لديك حساب؟" } },
    "hasAccount": { "t": 0, "b": { "t": 2, "i": [{ "t": 3 }], "s": "لديك حساب بالفعل؟" } }
  },
  "thoughts": {
    "title": { "t": 0, "b": { "t": 2, "i": [{ "t": 3 }], "s": "أفكاري" } },
    "add": { "t": 0, "b": { "t": 2, "i": [{ "t": 3 }], "s": "إضافة فكرة" } },
    "edit": { "t": 0, "b": { "t": 2, "i": [{ "t": 3 }], "s": "تعديل الفكرة" } },
    "delete": { "t": 0, "b": { "t": 2, "i": [{ "t": 3 }], "s": "حذف الفكرة" } },
    ...
    "form": {
      ...
      "category": { "t": 0, "b": { "t": 2, "i": [{ "t": 3 }], "s": "الفئة" } },
      "tags": { "t": 0, "b": { "t": 2, "i": [{ "t": 3 }], "s": "العلامات" } },
      "color": { "t": 0, "b": { "t": 2, "i": [{ "t": 3 }], "s": "اللون" } },
      "save": { "t": 0, "b": { "t": 2, "i": [{ "t": 3 }], "s": "حفظ الفكرة" } },
      "cancel": { "t": 0, "b": { "t": 2, "i": [{ "t": 3 }], "s": "إلغاء" } }
    }
  },
  "categories": {
    "title": { "t": 0, "b": { "t": 2, "i": [{ "t": 3 }], "s": "الفئات" } },
    "add": { "t": 0, "b": { "t": 2, "i": [{ "t": 3 }], "s": "إضافة فئة" } },
    "edit": { "t": 0, "b": { "t": 2, "i": [{ "t": 3 }], "s": "تعديل الفئة" } },
    "delete": { "t": 0, "b": { "t": 2, "i": [{ "t": 3 }], "s": "حذف الفئة" } },
    "form": {
      "name": { "t": 0, "b": { "t": 2, "i": [{ "t": 3 }], "s": "اسم الفئة" } },
      "color": { "t": 0, "b": { "t": 2, "i": [{ "t": 3 }], "s": "اللون" } },
      "icon": { "t": 0, "b": { "t": 2, "i": [{ "t": 3 }], "s": "الأيقونة" } },
      "save": { "t": 0, "b": { "t": 2, "i": [{ "t": 3 }], "s": "حفظ الفئة" } },
      "cancel": { "t": 0, "b": { "t": 2, "i": [{ "t": 3 }], "s": "إلغاء" } }
    }
  },
  "tags": {
    "add": { "t": 0, "b": { "t": 2, "i": [{ "t": 3 }], "s": "إضافة علامة" } },
    "placeholder": { "t": 0, "b": { "t": 2, "i": [{ "t": 3 }], "s": "أدخل اسم العلامة..." } }
  },
  "ui": {
  ...
  "validation": {
    ...
    "minLength": { "t": 0, "b": { "t": 2, "i": [{ "t": 3, "v": "الحد الأدنى " }, { "t": 4, "k": "min" }, { "t": 3, "v": " أحرف مطلوب" }] } },
    "maxLength": { "t": 0, "b": { "t": 2, "i": [{ "t": 3, "v": "الحد الأقصى " }, { "t": 4, "k": "max" }, { "t": 3, "v": " أحرف مسموح" }] } }
  }
};
const localeCodes = [
  "en",
...
const normalizedLocales = [
  {
    ...
    files: [
      {
        path: "G:/DEV/Practice/NuxtJs/Thought Cache/i18n/locales/en.json",
        cache: void 0
      }
    ]
  },
  {
    ...
    files: [
      {
        path: "G:/DEV/Practice/NuxtJs/Thought Cache/i18n/locales/ar.json",
        cache: void 0
      }
    ]
  }
...
var plugin_default = /* @__PURE__ */ defineNuxtPlugin((nuxtApp) => {
  ...
  {
    initialState.value = (_a2 = nuxtApp.ssrContext) == null ? void 0 : _a2.event.context.__clerk_initial_state;
  }
  ...
  setup(__props) {
    useHead({
      ...
      meta: [
        {
          name: "description",
          content: "Capture your brilliant ideas anytime, anywhere"
        },
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(_component_UApp, _attrs, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div${ssrRenderAttr("dir", _ctx.$i18n.locale === "ar" ? "rtl" : "ltr")}${_scopeId}>`);
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import('./error-404-C6oZRBac.mjs'));
    const _Error = defineAsyncComponent(() => import('./error-500-mancTMyh.mjs'));
