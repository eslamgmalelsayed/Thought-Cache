...
import { makeAuthObjectSerializable, stripPrivateDataFromObject, constants, AuthStatus } from '@clerk/backend/internal';
...
const _inlineRuntimeConfig = {
  ...
  "clerkSecretKey": "sk_test_YAmnjvPCeVfhFzhBGNBxnW1WxHL9kSyGBU04b3j9UE",
  "databaseUrl": "",
  "directUrl": "",
  "icon": {
...
const _x7nkZi_uAovBNwWvdCx0q05UDda1K5hOGDvZfg9IA = (function(nitro) {
...
const plugins = [
  _x7nkZi_uAovBNwWvdCx0q05UDda1K5hOGDvZfg9IA
];

const _GvvEO9 = defineEventHandler(async (event) => {
  var _a;
  ...
  if (publicRoutes.some((route) => {
    var _a2;
    return (_a2 = event.node.req.url) == null ? void 0 : _a2.startsWith(route);
  })) {
    return;
  }
...
const _5mZBJj = defineCachedEventHandler(async (event) => {
...
const clerkMiddleware = (...args) => {
  ...
  return eventHandler(async (event) => {
    ...
    if (requestState.status === AuthStatus.Handshake) {
      throw createError$1("Clerk: handshake status without redirect");
    }
...
const handlers = [
  ...
  { route: '/**', handler: _lazy_RWhkqZ, lazy: true, middleware: false, method: undefined }
];
